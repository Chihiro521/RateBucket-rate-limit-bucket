...
`;
  ...
  class UsageWidget {
    ...
    renderNahidaCapsule(platform2, value, onClick) {
    ...
    renderChatGptHeader() {
      ...
      chibi.src = chrome.runtime.getURL("nihida.webp");
      header.append(chibi);
    ...
    renderCollapsed() {
      ...
      const platform2 = PLATFORM_LABEL[this.platform];
      const capsule = this.renderNahidaCapsule(platform2, value, () => {
        this.expanded = true;
        this.render();
      });
